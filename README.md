...
# Demo
You can check out the application running live on my own personal server from this link. [shopee clone](https://shopee-clone.hosean.my.id).

# Run on local machine
Be sure to have docker and docker compose installed on your local machine. [install](https://docs.docker.com/compose/install/).
